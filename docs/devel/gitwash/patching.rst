...
Then, send the generated patch files to the `Smile
...
#. Finally, make your commits into patches.  You want all the
   ...
   Send these files to the `Smile mailing list`_.
...
Fork the `Smile`_ repository on github |emdash| :ref:`forking`.
Then::
   ...
   git remote add origin git@github.com:your-user-name/smile.git
