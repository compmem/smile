...
class Beep(Wait):
    ...
    finalize_time : float
        The time this state
    freq : integer
        The frequency of the played beep
    volume : float
        The volume of the played beep
    fadein : float
        The time to fade the beep in, in seconds. 
    fadeout : float
        The time to fade the beep out, in seconds.
...
class SoundFile(Wait):
    ...
    finalize_time : float
        The time this state
    filename : string
        The filename for the sound played
    volume : float
        The volume of the sound played
    start : float
        The time, in seconds, in the sound file that we started playing. 
    stop : float 
        The time, in seconds, in the sound file that we stopped playing. 
    loop : boolean
        The value of the parameter *loop* that was passed in. 
    sound_start_time : float
...
class RecordSoundFile(Wait):
    ...
    finalize_time : float
        The time this state
    filename : string
        The name of the file that the recording will be saved into. 
    filepath : string
