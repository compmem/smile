...
class KeyPress(KeyState):
    ...
    finalize_time : float
        The time this state
    buttons : list
        A list of strings with the names of buttons that are valid and this *KeyPress*
        state is listening for. 
    correct_resp : string, tuple, list
        A string, tuple, or list of strings that contain the names of correct key responses
        for this *KeyPress*.
    base_time : float
