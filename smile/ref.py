    ...
    *str()* and hope that it evaluates. Your code would break. Instead, you can
    ...
    def cond(cond, true_val, false_val):
        ...
        **cond** creates a Ref that will evaluate to the *true_val* if the
        ...
        Returns
        -------
        **cond** returns a ref with that will evaluate to either the *true_val*
        or *false_val* depending on the *cond* parameter.
    ...
    def add_change_callback(self, func, *pargs, **kwargs):
        ...
        """
        # print ("add_change_callback %s, %r, %r, %r" %
        #       (self, func, pargs, kwargs))
    ...
    def remove_change_callback(self, func, *pargs, **kwargs):
        # print ("remove_change_callback %s, %r, %r, %r" %
        #       (self, func, pargs, kwargs))
...
def val(obj):
    try:
        ...
        raise NotAvailableError("val(%r) produced NotAvailable"
                                "result" % repr(obj))
