    ...
    *str()* and hope that it evaluates. Your code would break. Instead, you can
    ...
    def cond(cond, true_val, false_val):
        ...
        **cond** creates a Ref that will evaluate to the *true_val* if the
        ...
        It allows you do create parameters for different states that can
        vary without using an **If** state.
    ...
    def add_change_callback(self, func, *pargs, **kwargs):
        ...
        """
        # print "add_change_callback %s, %r, %r, %r" % (self, func,
        #                                               pargs, kwargs)
    ...
    def remove_change_callback(self, func, *pargs, **kwargs):
        # print "remove_change_callback %s, %r, %r, %r" % (self, func,
        #                                                  pargs, kwargs)
