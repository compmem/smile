...
class Subroutine(object):
    ...
    your *Subroutine* is always **self**.
...
class If(SequentialState):
    ...
    **conditional** in the list is always a *True* boolean, which then 
    ...
    conditional : logical 
        ...
        means you maynot use **and** or **or**. You must use *&* and *|* in order
...
class Loop(SequentialState):
    ...
    **do while** depending on what parameters you send into it. 
    ...
    iterable : iterable (default = None, optional)
        This is any iterable class. i.e. List, Seq, String, Tuple.  If this veriable 
    ...
    shuffle : Boolean (default = False, optional)
        If shuffle is set to True, then the iterable that was passed into iterable 
        will be shuffled before it is presented. 
...
class Record(State):
    ...
    all of them to a .slog file. Pass in Reference arguments by using kwargs.  
...
class Done(AutoFinalizeState):
    """A *Done* state will blcok the experiment from continuing until a Ref value is filled, 
